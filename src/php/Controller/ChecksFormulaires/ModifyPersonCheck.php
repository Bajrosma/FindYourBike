...
if (!isset($_GET["Update"])) {
    ...
    $fields = [
        ...
        'perRole' => [ // Validation pour les rôles comme citoyen.ne, responsable technique, etc.
            'regex' => '/^[A-Za-zÀ-ÿ\s\-\'\.]{2,}$/u',
            'error' => 'Veuillez entrer un nom valide (lettres uniquement, espaces, tirets, apostrophes ou points autorisés).'
        ]
    ];
    ...
    if ($isValid) {
        ...
        $_SESSION["MessageAdd"] = "Personne modifier avec succès !";
    ...
    header("Location: ../../View/Modify/ModifyPersonPage.php" . $_POST["ID_personne"]);
    exit;
}