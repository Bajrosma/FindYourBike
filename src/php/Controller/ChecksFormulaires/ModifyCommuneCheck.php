...
if (!isset($_GET["Update"])) {
    ...
    if ($isValid) {
        ...
        $_SESSION["MessageAdd"] = "Commune modifier avec succès !";
    ...
    header("Location: ../../View/Modify/ModifyCommunePage.php?ID=" . $_POST["ID_commune"]);
    exit;
} else {
    ...
    header("Location: ../../View/Modify/ModifyCommunePage.php" . $_POST["ID_commune"]);
    exit;
}